...
See [exercises](./exercises) for solution of [rustlings@v5.0.0](https://github.com/rust-lang/rustlings/tree/5.0.0).
Below content are the original readme of the source.
